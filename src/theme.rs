...
impl Theme {
    ...
    fn dark() -> Self {
        Self {
            ...
            sidebar_foreground: rgb(0xb8b8b8).into(),
    ...
    fn ayu_mirage() -> Self {
        Self {
            ...
            sidebar_foreground: rgb(0x9aa4b6).into(),
    ...
    fn kanagawa() -> Self {
        Self {
            ...
            sidebar_foreground: rgb(0xb0aa94).into(),
    ...
    fn everforest() -> Self {
        Self {
            ...
            sidebar_foreground: rgb(0x9aa79d).into(),
    ...
    fn gruvbox_material() -> Self {
        Self {
            ...
            sidebar_foreground: rgb(0xa89984).into(),
    ...
    fn catppuccin_mocha() -> Self {
        Self {
            ...
            sidebar_foreground: rgb(0xa6adc8).into(),
    ...
    fn light() -> Self {
        Self {
            ...
            sidebar_foreground: rgb(0x4f4f4f).into(),
